...
<!--FIN del la ficha de consulta-->
  <form method="post" action="php/guardar/guardarCita.php" id="miform">
    ...
    <div class="box  box-warning">
      ...
      <div class="box-body">
          ...
          <div>
            <label>* Cita</label>
            <textarea name="cita" maxlength="199" class="form-control" required="required" onBlur="javascript:this.value=this.value.toUpperCase();"></textarea>
          </div>

</div>
          <input type="submit" class="btn btn-warning btn-flat pull-right" value="Guardar Cita"/>
          <a href="javascript:limpiar();" class="btn btn-danger btn-flat pull-right">Limpiar Cita</a>
        </form>
      <!--INICIO-->
      <?php
      }
