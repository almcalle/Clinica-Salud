...
$registros = mysql_query("select * from citas where id='".$buscar."'");
$reg = mysql_num_rows($registros);
if ($reg==0) {

}
else{
	 $cita = mysql_fetch_array($registros);
     $consulta = mysql_query("select * from ficha where identidad='".$cita['identidad']."'");
...
<div class="panel-body">
	<dl>
        ...
        <dt>Tratamiento</dt>
        <dd><?php echo $cita['cita'];?></dd>
        <dt>Fecha:</dt>
        <dd><?php echo $cita['fecha'];?></dd>
    </dl>
</div>
